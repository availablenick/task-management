...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var content = document.querySelector(".custom-content");
  var filler = document.querySelector(".custom-filler");
  ...
  var deleteButtons = document.querySelectorAll(".custom-btn-delete");
  ...
  var alertBtn = document.querySelector(".custom-btn-alert");
  var alertPanel = document.querySelector(".custom-alert-panel");
  alertBtn.addEventListener("click", function () {
    var alertCount = document.querySelector(".custom-alert-count");
  ...
  document.addEventListener("click", function (event) {
    if (document.body.contains(event.target) && !alertPanel.contains(event.target) && !alertBtn.contains(event.target)) {
      alertPanel.style.display = "";
    }
  });
});
